...
export const metadata = {
  title: "La Gloria Cubana Prices UK | Cigar Ledger",
  description: "Compare La Gloria Cubana cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>La Gloria Cubana Prices UK</h1>

        <p className="lead">
          Compare La Gloria Cubana cigar prices in the UK before buying. Prices can vary between retailers,
          formats, stock levels and import routes, so the cheapest headline price is not always
          the best final deal.
        </p>

        <section>
          <h2>Why La Gloria Cubana prices vary</h2>
          <p>
            La Gloria Cubana prices can change depending on stock, cigar size, box quantity, retailer margin,
