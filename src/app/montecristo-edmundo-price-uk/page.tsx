...
export const metadata = {
  title: "Montecristo Edmundo Price UK | Cigar Ledger",
  description: "Compare Montecristo Edmundo prices in the UK and find better cigar value.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Montecristo Edmundo Price UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Montecristo Edmundo Price UK</a>
