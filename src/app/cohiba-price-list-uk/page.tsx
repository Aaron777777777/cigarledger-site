...
export const metadata = {
  title: "Cohiba Price List UK | Cigar Ledger",
  description: "Compare Cohiba cigar prices in the UK and find better value with Cigar Ledger.",
};
    ...
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Cohiba Price List UK</a>
