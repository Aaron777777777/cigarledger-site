...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    "/terms",
    "/watchlist",
    "/quai-dorsay-prices-uk",
    "/juan-lopez-prices-uk",
    "/vegueros-prices-uk",
    "/san-cristobal-prices-uk",
    "/punch-prices-uk",
    "/quintero-prices-uk",
    "/jose-l-piedra-prices-uk",
    "/la-gloria-cubana-prices-uk",
    "/el-rey-del-mundo-prices-uk",
    "/sancho-panza-prices-uk",
    "/cigars",
    "/cheap-cigars-uk",
    "/cheapest-cigars-uk",
    ...
    "/bolivar-prices-uk",
    "/trinidad-prices-uk",
    "/hoyo-de-monterrey-prices-uk",
    "/ramon-allones-prices-uk",
    "/por-larranaga-prices-uk",
