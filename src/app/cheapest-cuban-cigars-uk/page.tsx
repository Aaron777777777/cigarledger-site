...
export const metadata: Metadata = {
  ...
  description: "Find cheaper Cuban cigars in the UK and compare price ranges across popular Cuban brands with Cigar Ledger.",
};
    ...
    <>
      ...
      <main className="seo-page">
        <section className="seo-hero">
          ...
          <p>Find cheaper Cuban cigars in the UK and compare price ranges across popular Cuban brands with Cigar Ledger.</p>
        </section>
