...
export const metadata: Metadata = {
  title: "Cheapest Cuban Cigars UK | Cigar Ledger",
  description: "Find cheaper Cuban cigars in the UK and compare popular Cuban cigar price ranges. Download Cigar Ledger to compare cigar prices and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        ...
        <section className="seo-hero">
          ...
          <h1>Cheapest Cuban Cigars UK</h1>
          <p>Find cheaper Cuban cigars in the UK and compare popular Cuban cigar price ranges. Cigar Ledger helps you compare prices, track favourites and make better buying decisions from the app.</p>
        </section>
        ...
        <section className="content-card">
          ...
          <p>
            Searches like <strong>cheapest Cuban cigars UK</strong>, <strong>Cuban cigar prices UK</strong> and <strong>affordable Cuban cigars UK</strong> usually mean one thing:
