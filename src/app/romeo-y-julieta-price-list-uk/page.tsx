...
export const metadata = {
  title: "Romeo y Julieta Price List UK | Cigar Ledger",
  description: "Compare Romeo y Julieta cigar prices in the UK with Cigar Ledger.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Romeo y Julieta Price List UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Romeo y Julieta Price List UK</a>
