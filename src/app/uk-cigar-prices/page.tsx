...
export const metadata = {
  title: "UK Cigar Prices | Cigar Ledger",
  description: "Track UK cigar prices, compare popular cigars and find better deals with Cigar Ledger.",
};
    ...
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">UK Cigar Prices</a>
