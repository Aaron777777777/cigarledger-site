...
export const metadata = {
  title: "Best Cigars Under £20 UK | Cigar Ledger",
  description: "Compare cigars under £20 and find better value. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <h1>Best Cigars Under £20 UK</h1>
        <p>Compare cigars under £20 and find better value.</p>
        <p>
