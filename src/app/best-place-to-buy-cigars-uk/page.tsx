...
export const metadata = {
  title: "Best Place to Buy Cigars UK | Cigar Ledger",
  description: "Find the best places to buy cigars in the UK and compare prices with Cigar Ledger.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Best Place to Buy Cigars UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Best Place to Buy Cigars UK</a>
