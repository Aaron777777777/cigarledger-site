...
export const metadata: Metadata = {
  title: "Cigar Deals UK | Cigar Ledger",
  description: "Looking for cigar deals in the UK? Compare prices and spot better-value cigars. Download Cigar Ledger to compare cigar prices and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        ...
        <section className="content-card">
          ...
          <p>
            Searches like <strong>cigar deals UK</strong>, <strong>cigar offers UK</strong> and <strong>cigar bargains</strong> usually mean one thing:
