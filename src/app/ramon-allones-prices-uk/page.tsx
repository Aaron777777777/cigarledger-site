  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <p className="lead">
          Compare Ramon Allones cigar prices in the UK before buying. Prices can vary between retailers,
        ...
        <section>
          ...
          <p>
            Ramon Allones prices can change depending on stock, cigar size, box quantity, retailer margin,
