...
export const metadata = {
  ...
  description: "Check H. Upmann Magnum 46 prices in the UK. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage seoArticle cigarDetailPage">
        ...
        <p className="lead">
          Check H. Upmann Magnum 46 prices before you buy. UK cigar prices can move between shops,
        ...
        <section>
          ...
          <p>
            Before ordering H. Upmann Magnum 46, compare the current UK retail price against other
