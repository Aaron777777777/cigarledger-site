  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage seoArticle cigarDetailPage">
        ...
        <h1>Partagás Serie D No. 4 Price UK</h1>
        <p className="lead">
          Check Partagás Serie D No. 4 prices before you buy. UK cigar prices can move between shops,
        ...
        <section>
          ...
          <p>
            Before ordering Partagás Serie D No. 4, compare the current UK retail price against other
