...
export const metadata = {
  title: "Juan Lopez Prices UK | Cigar Ledger",
  description: "Compare Juan Lopez cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Juan Lopez Prices UK</h1>

        <p className="lead">
          Compare Juan Lopez cigar prices in the UK before buying. Prices can vary between retailers,
          formats, stock levels and import routes, so the cheapest headline price is not always
          the best final deal.
        </p>

        <section>
          <h2>Why Juan Lopez prices vary</h2>
          <p>
            Juan Lopez prices can change depending on stock, cigar size, box quantity, retailer margin,
