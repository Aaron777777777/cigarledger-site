...
export const metadata: Metadata = {
  title: "Cigar Discounts UK | Cigar Ledger",
  description: "Find cigar discounts, offers and better-value cigar prices in the UK. Download Cigar Ledger to compare cigar prices and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        ...
        <section className="seo-hero">
          ...
          <h1>Cigar Discounts UK</h1>
          <p>Find cigar discounts, offers and better-value cigar prices in the UK. Cigar Ledger helps you compare prices, track favourites and make better buying decisions from the app.</p>
        </section>
        ...
        <section className="content-card">
          ...
          <p>
            Searches like <strong>cigar discounts UK</strong>, <strong>cigar offers</strong> and <strong>discount cigar prices</strong> usually mean one thing:
