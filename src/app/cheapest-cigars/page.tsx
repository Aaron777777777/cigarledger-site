...
export const metadata: Metadata = {
  title: "Cheapest Cigars | Cigar Ledger",
  description: "Discover some of the cheapest cigars and compare prices before you buy. Download Cigar Ledger to compare cigar prices and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        ...
        <section className="seo-hero">
          ...
          <h1>Cheapest Cigars</h1>
          <p>The cheapest cigar is not always the one you should buy, but price still matters. This guide helps you think about low-cost cigars in a more useful way before comparing prices in Cigar Ledger.</p>
        </section>
        ...
        <section className="content-card">
          ...
          <p>
            Searches like <strong>cheapest cigars</strong>, <strong>lowest cigar prices</strong> and <strong>best value cigars</strong> usually mean one thing:
