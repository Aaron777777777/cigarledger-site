...
export const metadata: Metadata = {
  ...
  description: "Discover some of the cheapest cigars available and use Cigar Ledger to compare prices, track favourites and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        <section className="seo-hero">
          ...
          <p>Discover some of the cheapest cigars available and use Cigar Ledger to compare prices, track favourites and find better deals.</p>
        </section>
