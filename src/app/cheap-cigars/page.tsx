...
export const metadata: Metadata = {
  ...
  description: "Find cheap cigars without wasting time checking every retailer. Download Cigar Ledger to compare cigar prices and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        ...
        <section className="content-card">
          ...
          <p>
            Searches like <strong>cheap cigars</strong>, <strong>affordable cigars</strong> and <strong>budget cigars</strong> usually mean one thing:
