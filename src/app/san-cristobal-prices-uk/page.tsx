...
export const metadata = {
  title: "San Cristobal Prices UK | Cigar Ledger",
  description: "Compare San Cristobal cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>San Cristobal Prices UK</h1>

        <p className="lead">
          Compare San Cristobal cigar prices in the UK before buying. Prices can vary between retailers,
          formats, stock levels and import routes, so the cheapest headline price is not always
          the best final deal.
        </p>

        <section>
          <h2>Why San Cristobal prices vary</h2>
          <p>
            San Cristobal prices can change depending on stock, cigar size, box quantity, retailer margin,
