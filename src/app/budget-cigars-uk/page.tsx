...
export const metadata = {
  title: "Budget Cigars UK | Cigar Ledger",
  description: "Find budget cigars in the UK and compare prices before buying. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <h1>Budget Cigars UK</h1>
        <p>Find budget cigars in the UK and compare prices before buying.</p>
        <p>
