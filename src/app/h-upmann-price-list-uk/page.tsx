...
export const metadata = {
  title: "H. Upmann Price List UK | Cigar Ledger",
  description: "Compare H. Upmann cigar prices in the UK and discover better cigar deals.",
};
    ...
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">H. Upmann Price List UK</a>
