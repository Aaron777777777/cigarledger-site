...
export const metadata: Metadata = {
  title: "Cheapest Cuban Cigars | Cigar Ledger",
  description: "Compare cheaper Cuban cigar options and check price ranges before you buy. Download Cigar Ledger to compare cigar prices and find better deals.",
};
    ...
    <>
      <main className="seo-page">
        ...
        <section className="seo-hero">
          ...
          <h1>Cheapest Cuban Cigars</h1>
          <p>Compare cheaper Cuban cigar options and check price ranges before you buy. Cigar Ledger helps you compare prices, track favourites and make better buying decisions from the app.</p>
        </section>
        ...
        <section className="content-card">
          ...
          <p>
            Searches like <strong>cheapest Cuban cigars</strong>, <strong>Cuban cigar prices</strong> and <strong>affordable Cuban cigars</strong> usually mean one thing:
