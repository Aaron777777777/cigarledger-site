...
export const metadata = {
  title: "Montecristo No. 4 Price UK | Cigar Ledger",
  description: "Check Montecristo No. 4 prices in the UK. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage seoArticle cigarDetailPage">
        ...
        <h1>Montecristo No. 4 Price UK</h1>
        <p className="lead">
          Check Montecristo No. 4 prices before you buy. UK cigar prices can move between shops,
        ...
        <section>
          ...
          <p>
            Before ordering Montecristo No. 4, compare the current UK retail price against other
