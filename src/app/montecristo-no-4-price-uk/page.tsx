export const metadata = {
  ...
  description: "Compare Montecristo No. 4 prices before buying. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <p>Compare Montecristo No. 4 prices before buying.</p>
        <p>
