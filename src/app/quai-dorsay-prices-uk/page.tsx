...
export const metadata = {
  title: "Quai d'Orsay Prices UK | Cigar Ledger",
  description: "Compare Quai d'Orsay cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Quai d'Orsay Prices UK</h1>

        <p className="lead">
          Compare Quai d'Orsay cigar prices in the UK before buying. Prices can vary between retailers,
          formats, stock levels and import routes, so the cheapest headline price is not always
          the best final deal.
        </p>

        <section>
          <h2>Why Quai d'Orsay prices vary</h2>
          <p>
            Quai d'Orsay prices can change depending on stock, cigar size, box quantity, retailer margin,
