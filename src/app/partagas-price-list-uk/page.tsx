...
export const metadata = {
  title: "Partagas Price List UK | Cigar Ledger",
  description: "Compare Partagas cigar prices in the UK and find current price ranges with Cigar Ledger.",
};
    ...
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Partagas Price List UK</a>
