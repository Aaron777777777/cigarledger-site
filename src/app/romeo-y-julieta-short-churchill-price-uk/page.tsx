export const metadata = {
  ...
  description: "Compare Romeo y Julieta Short Churchill prices. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <p>Compare Romeo y Julieta Short Churchill prices.</p>
        <p>
