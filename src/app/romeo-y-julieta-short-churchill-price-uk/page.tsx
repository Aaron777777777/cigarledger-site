  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage seoArticle">
        ...
        <h1>Romeo y Julieta Short Churchill Price UK</h1>
        <p className="lead">
          Check Romeo y Julieta Short Churchill prices before you buy. UK cigar prices can move between shops,
        ...
        <section>
          ...
          <p>
            Before ordering Romeo y Julieta Short Churchill, compare the current UK retail price against other
