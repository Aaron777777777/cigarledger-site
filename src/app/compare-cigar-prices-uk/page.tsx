export const metadata = {
  ...
  description: "Compare UK cigar prices before placing your next order. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <p>Compare UK cigar prices before placing your next order.</p>
        <p>
