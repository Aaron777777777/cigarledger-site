...
export const metadata = {
  title: "Vegueros Prices UK | Cigar Ledger",
  description: "Compare Vegueros cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Vegueros Prices UK</h1>

        <p className="lead">
          Compare Vegueros cigar prices in the UK before buying. Prices can vary between retailers,
          formats, stock levels and import routes, so the cheapest headline price is not always
          the best final deal.
        </p>

        <section>
          <h2>Why Vegueros prices vary</h2>
          <p>
            Vegueros prices can change depending on stock, cigar size, box quantity, retailer margin,
