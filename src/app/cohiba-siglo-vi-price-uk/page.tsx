export const metadata = {
  ...
  description: "Compare Cohiba Siglo VI prices before buying. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <p>Compare Cohiba Siglo VI prices before buying.</p>
        <p>
