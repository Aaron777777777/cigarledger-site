...
export const metadata = {
  title: "Cohiba Siglo VI Price UK | Cigar Ledger",
  description: "Check Cohiba Siglo VI prices in the UK. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage seoArticle cigarDetailPage">
        ...
        <h1>Cohiba Siglo VI Price UK</h1>
        <p className="lead">
          Check Cohiba Siglo VI prices before you buy. UK cigar prices can move between shops,
        ...
        <section>
          ...
          <p>
            Before ordering Cohiba Siglo VI, compare the current UK retail price against other
