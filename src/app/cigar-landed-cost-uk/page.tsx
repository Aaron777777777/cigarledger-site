export const metadata = {
  ...
  description: "Estimate the final landed cost of importing cigars into the UK. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <p>Estimate the final landed cost of importing cigars into the UK.</p>
        <p>
