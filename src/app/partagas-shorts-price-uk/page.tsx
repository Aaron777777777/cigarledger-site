...
export const metadata = {
  title: "Partagas Shorts Price UK | Cigar Ledger",
  description: "Compare Partagas Shorts prices in the UK with Cigar Ledger.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Partagas Shorts Price UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Partagas Shorts Price UK</a>
