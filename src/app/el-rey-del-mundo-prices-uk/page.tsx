...
export const metadata = {
  title: "El Rey del Mundo Prices UK | Cigar Ledger",
  description: "Compare El Rey del Mundo cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>El Rey del Mundo Prices UK</h1>

        <p className="lead">
          Compare El Rey del Mundo cigar prices in the UK before buying. Prices can vary between retailers,
          formats, stock levels and import routes, so the cheapest headline price is not always
          the best final deal.
        </p>

        <section>
          <h2>Why El Rey del Mundo prices vary</h2>
          <p>
            El Rey del Mundo prices can change depending on stock, cigar size, box quantity, retailer margin,
