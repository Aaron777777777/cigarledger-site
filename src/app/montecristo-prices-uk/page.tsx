export const metadata = {
  title: "Montecristo Prices UK | Cigar Ledger",
  description: "Compare Montecristo cigar prices in the UK. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <h1>Montecristo Prices UK</h1>
        <p>Compare Montecristo cigar prices in the UK.</p>
        <p>
