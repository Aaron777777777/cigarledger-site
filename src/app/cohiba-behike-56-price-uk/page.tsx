...
export const metadata = {
  title: "Cohiba Behike 56 Price UK | Cigar Ledger",
  description: "Check Cohiba Behike 56 UK price guidance and compare cigar prices with Cigar Ledger.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Cohiba Behike 56 Price UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Cohiba Behike 56 Price UK</a>
