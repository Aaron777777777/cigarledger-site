...
export const metadata = {
  title: "Buy Cigars Online UK | Cigar Ledger",
  description: "Looking to buy cigars online in the UK? Use Cigar Ledger to compare prices and find better value.",
};
    ...
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Buy Cigars Online UK</a>
