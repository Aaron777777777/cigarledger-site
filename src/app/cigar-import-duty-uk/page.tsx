export const metadata = {
  ...
  description: "Estimate UK cigar import duty and landed costs before buying. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage">
        ...
        <p>Estimate UK cigar import duty and landed costs before buying.</p>
        <p>
