...
export const metadata = {
  title: "Trinidad Prices UK | Cigar Ledger",
  description: "Compare Trinidad cigar prices in the UK, check buying routes and estimate landed costs before buying.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Trinidad Prices UK</h1>

        <p className="lead">
          Compare Trinidad cigar prices in the UK before buying. Prices can vary between retailers,
        ...
        <section>
          <h2>Why Trinidad prices vary</h2>
          <p>
            Trinidad prices can change depending on stock, cigar size, box quantity, retailer margin,
