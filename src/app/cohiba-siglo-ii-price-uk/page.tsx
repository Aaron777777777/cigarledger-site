...
export const metadata = {
  title: "Cohiba Siglo II Price UK | Cigar Ledger",
  description: "Check Cohiba Siglo II prices in the UK. Cigar Ledger helps UK cigar smokers compare prices, landed costs and buying routes.",
};
  ...
  return (
    <main className="page">
      ...
      <section className="hero smallHero seoPage seoArticle cigarDetailPage">
        ...
        <p className="lead">
          Check Cohiba Siglo II prices before you buy. UK cigar prices can move between shops,
        ...
        <section>
          ...
          <p>
            Before ordering Cohiba Siglo II, compare the current UK retail price against other
