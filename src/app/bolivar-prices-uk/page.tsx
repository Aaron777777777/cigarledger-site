  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <p className="lead">
          Compare Bolivar cigar prices in the UK before buying. Prices can vary between retailers,
        ...
        <section>
          ...
          <p>
            Bolivar prices can change depending on stock, cigar size, box quantity, retailer margin,
