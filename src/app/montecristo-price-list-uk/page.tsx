...
export const metadata = {
  title: "Montecristo Price List UK | Cigar Ledger",
  description: "Compare Montecristo cigar prices in the UK and track popular cigars with Cigar Ledger.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Montecristo Price List UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Montecristo Price List UK</a>
