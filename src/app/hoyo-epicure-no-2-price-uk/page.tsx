...
export const metadata = {
  title: "Hoyo de Monterrey Epicure No. 2 Price UK | Cigar Ledger",
  description: "Compare Hoyo de Monterrey Epicure No. 2 prices in the UK with Cigar Ledger.",
};
  ...
  return (
    <main className="page">
      ...
      <article className="seoArticle">
        ...
        <h1>Hoyo de Monterrey Epicure No. 2 Price UK</h1>
        ...
        <div className="relatedLinks">
          <a href="/cheap-cigars-uk">Hoyo de Monterrey Epicure No. 2 Price UK</a>
